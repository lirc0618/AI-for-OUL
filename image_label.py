...
def generate(dir, label):
    ...
    print('input :', dir)
    print('start...')
    #listText = open('E:/GitHub/AgNPs/0326/02-01/Data/AI/UniAut3/train/train.txt', 'a+')  #创建并打开一个txt文件，a+表示打开一个文件并追加内容
    #listText = open('E:/GitHub/AgNPs/0326/02-01/Data/AI/UniAut3/val/val.txt', 'a+')  #创建并打开一个txt文件，a+表示打开一个文件并追加内容
    listText = open('E:/GitHub/AgNPs/0326/02-01/Data/AI/UniAut3/test/test.txt', 'a+')  #创建并打开一个txt文件，a+表示打开一个文件并追加内容
...
#train_path = 'E:/GitHub/AgNPs/0326/02-01/Data/AI/UniAut3/train'  # 这里是你的图片路径
#val_path = 'E:/GitHub/AgNPs/0326/02-01/Data/AI/UniAut3/val'  # 这里是你的图片路径
test_path = 'E:/GitHub/AgNPs/0326/02-01/Data/AI/UniAut3/test'  # 这里是你的图片路径
...
if __name__ == '__main__':  #主函数
    ...
    i = 1
    test_list = os.listdir(test_path)# 列举文件夹
    for folder in test_list:  #遍历文件夹中的文件夹(若engagement文件夹中存在txt或py文件，则后面会报错）
        generate(os.path.join(test_path, folder), i)#调用generate函数，函数中的参数为：（图片路径+文件夹名，标签号）
        i += 1